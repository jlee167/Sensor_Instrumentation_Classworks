...
# MC2-70 
set_property PACKAGE_PIN T15 [get_ports {LED[3]}]
...
# XEM LEDs #####################################################################
set_property PACKAGE_PIN A13 [get_ports {xled[0]}]
set_property PACKAGE_PIN B13 [get_ports {xled[1]}]
set_property PACKAGE_PIN A14 [get_ports {xled[2]}]
set_property PACKAGE_PIN A15 [get_ports {xled[3]}]
set_property PACKAGE_PIN B15 [get_ports {xled[4]}]
set_property PACKAGE_PIN A16 [get_ports {xled[5]}]
set_property PACKAGE_PIN B16 [get_ports {xled[6]}]
set_property PACKAGE_PIN B17 [get_ports {xled[7]}]
set_property IOSTANDARD LVCMOS15 [get_ports {xled[*]}]
