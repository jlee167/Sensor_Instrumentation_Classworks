...
#
# Generated by Vivado on Tue Nov 14 09:15:06 -0600 2017
...
# Script info
echo -e "ila.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila xil_defaultlib.ila xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim ila -key {Behavioral:sim_1:Functional:ila} -tclbatch cmd.tcl -log simulate.log
}
