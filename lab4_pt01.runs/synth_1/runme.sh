...
HD_PWD='C:/Users/jlee167/OKPipes/lab7pipeInPipeOut/lab4_pt01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pipeIn_PipeOut_framework.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pipeIn_PipeOut_framework.tcl
