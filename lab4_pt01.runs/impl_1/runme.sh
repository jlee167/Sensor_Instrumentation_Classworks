...
HD_PWD='C:/Users/jlee167/OKPipes/lab7pipeInPipeOut/lab4_pt01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pipeIn_PipeOut_framework.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pipeIn_PipeOut_framework.tcl -notrace
